...
ArToolkitContext = new THREEx.ArToolkitContext({
    cameraParametersUrl: '/sem-ar/assets/camera_para.dat',
...
ArMarkerControls = new THREEx.ArMarkerControls(ArToolkitContext, camera, {
    type: 'pattern',
    patternUrl: '/sem-ar/assets/pattern-marker.patt',
...
function createText() {
    fontLoader.load('/sem-ar/css/fonts/Roboto Black_Regular.json', (my_font) => {
